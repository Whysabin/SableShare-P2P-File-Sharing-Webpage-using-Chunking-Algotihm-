...
function generateRandomId() {
  return Math.random().toString(36).substr(2, 6).toUpperCase(); // Generates a random string of 9 characters
}

// Store the new ID in localStorage every time the page loads
localStorage.setItem('id', generateRandomId());

// Function to update the tooltip with the new ID
